...
| [Abilities](#abilities--domain-cards-189) | 189   | N/A       | Done        | V2 engine: 5 Arcana Tier 1 (`features-v2/abilities`); UI still display-first | **Partial** |
...
| -------- | --------- | ------- |
| Arcana   | 21        | Partial — Tier 1 Rune Ward, Unleash Chaos, Wall Walk, Cinder Grasp, Floating Eye in V2 `abilities/Arcana/` |
| Blade    | 21        | Display |
| Bone     | 21        | Display |
| Codex    | 21        | Display |
| Grace    | 21        | Display |

...
| Parry           | weapon_properties/Parry.js          | Done | impl-wpb5        | onReviewAction hook (isTargeted + attack): rolls weapon damage die via rollDie, cancels matching attacker dice values from damage effect |                                                                                                                                                                                                                                       |           |
| Persuasive      | weapon_properties/Persuasive.js     | Done | impl-wpb5        | Intent chip (isActing + Presence trait, stressCost: 1): onUse adds +2 static to action roll |                                                                                                                                                                                                                                       |           |
| Pompous         | weapon_properties/Pompous.js        | Done | impl-wpb5        | Purely narrative (weapon restriction: Presence 0 or lower) |                                                                                                                                                                                                                                       |           |
| Powerful        | weapon_properties/Powerful.js       | Done | impl-wpb5        | onReviewAction hook (isActing + attack + success): rolls extra damage die via rollDie, discards lowest (keep highest pattern) |                                                                                                                                                                                                                                       |           |
| Protective      | weapon_properties/Protective.js     | Validated | val-wp-simple-1 | passive stat mod: +1 Armor Score |                                                                                                                                                                                    |                                                                                                                                                                                                                                       |           |
| Quick           | weapon_properties/Quick.js          | Done | impl-wpb5        | reviewAction toggle chip (isActing + attack, stressCost: 1): narration for second target (no addTarget API) |                                                                                                                                                                                                                                       |           |

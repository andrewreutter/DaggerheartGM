...
| Danger Sense        | ancestries/Goblin.js   | Validated  | val-d9c1           | Review chip (rest frequency, 1 Stress) when adversary attacks me or ally within Very Close; forces reroll (requires engine support for actual reroll).                                                                                                                                          |                                                                                                                                                                                                                                                                                                                                                | Fixed: ally range check expanded from `=== 'veryClose'` to `=== 'melee'                                                                                                                                                                                                                                                                     |

...
| Long            | weapon_properties/Long.js           | Done | impl-awp1 | Purely narrative — multi-target line attack has no V2 mechanical hook |                                                                                                                                                                                                                                       |           |
| Lucky           | weapon_properties/Lucky.js          | Done | impl-awp1 | reviewAction chip (stressCost: 1): rerolls both duality dice on failed attack |                                                                                                                                                                                                                                       |           |
| Massive         | weapon_properties/Massive.js        | Done | impl-awp1 | passiveStatMods evasion -1; onReviewAction: rolls extra damage die and discards lowest on successful attack |                                                                                                                                                                                                                                       |           |
| Otherworldly    | weapon_properties/Otherworldly.js   | Done | impl-awp1 | Purely narrative — damage type choice is a UI-layer concern |                                                                                                                                                                                                                                       |           |
| Painful         | weapon_properties/Painful.js        | Done | impl-w2  | onResolve: when isActing + isSuccess, marks 1 Stress on attacker |                                                                                                                                                                                                                                       |           |
| Paired          | weapon_properties/Paired.js         | Done | impl-awp1 | onIntent: adds tier-scaling damage bonus (+tier+1) in melee attacks; reads weapon tier from table.me.weapons |                                                                                                                                                                                                                                       |           |

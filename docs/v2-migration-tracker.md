...
| Parry           | weapon_properties/Parry.js          | Done | impl-wpq1 | onReviewAction: when isTargeted + hasDamage, rolls parry weapon d6, discards matching attacker dice from damage. Uses name-matching to find parry weapon (engine doesn't populate weapon.features in snapshot). |                                                                                                                                                                                                                                       |           |
| Persuasive      | weapon_properties/Persuasive.js     | Done | impl-wpq1 | Intent chip: when isActing + Presence trait, stressCost 1, addStatic +2 to action roll. |                                                                                                                                                                                                                                       |           |
| Pompous         | weapon_properties/Pompous.js        | Done | impl-wpq1 | Purely narrative — weapon restriction (Presence ≤ 0). No V2 API for weapon restrictions. |                                                                                                                                                                                                                                       |           |
| Powerful        | weapon_properties/Powerful.js       | Done | impl-wpq1 | onReviewAction: when isActing + attack + success, rolls extra damage die (same type as weapon), keeps highest, adds difference to damage effect. |                                                                                                                                                                                                                                       |           |
| Protective      | weapon_properties/Protective.js     | Validated | val-wp-simple-1 | passive stat mod: +1 Armor Score |                                                                                                                                                                                    |                                                                                                                                                                                                                                       |           |
| Quick           | weapon_properties/Quick.js          | Done | impl-wpq1 | reviewAction chip: when isActing + attack, stressCost 1, addDamageRoll with weapon die against other adversaries in range. |                                                                                                                                                                                                                                       |           |

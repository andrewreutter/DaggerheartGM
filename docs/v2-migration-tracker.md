...
| Parry           | weapon_properties/Parry.js          | Done | impl-ppq1 | reviewAction toggle chip when targeted by attack; rolls d8, cancels matching attacker damage dice values |                                                                                                                                                                                                                                       |           |
| Persuasive      | weapon_properties/Persuasive.js     | Done | impl-ppq1 | intent toggle chip on Presence rolls; stressCost 1; adds +2 static to action roll |                                                                                                                                                                                                                                       |           |
| Pompous         | weapon_properties/Pompous.js        | Done | impl-ppq1 | Purely narrative — Presence restriction, no mechanical hooks |                                                                                                                                                                                                                                       |           |
| Powerful        | weapon_properties/Powerful.js       | Done | impl-ppq1 | onReviewAction: on successful attack, rolls extra damage die (same type), discards lowest via negative static |                                                                                                                                                                                                                                       |           |
| Protective      | weapon_properties/Protective.js     | Validated | val-wp-simple-1 | passive stat mod: +1 Armor Score |                                                                                                                                                                                    |                                                                                                                                                                                                                                       |           |
| Quick           | weapon_properties/Quick.js          | Done | impl-ppq1 | reviewAction toggle chip on attacks; stressCost 1; queues addDamageRoll for additional target |                                                                                                                                                                                                                                       |           |

...
| Long            | weapon_properties/Long.js           | Done | impl-wpb3 | Narrative only — multi-target line mechanic requires UI/engine support beyond the feature API |                                                                                                                                                                                                                                       |           |
| Lucky           | weapon_properties/Lucky.js          | Done | impl-wpb3 | reviewAction chip (stressCost: 1); on failed attack, rerolls both duality dice |                                                                                                                                                                                                                                       |           |
| Massive         | weapon_properties/Massive.js        | Done | impl-wpb3 | passiveStatMods: evasion -1; onIntent: addAdvantageDie on damage roll for attacks |                                                                                                                                                                                                                                       |           |
| Otherworldly    | weapon_properties/Otherworldly.js   | Done | impl-wpb3 | reviewAction toggle chip; on successful attack, mutates damageType to magic |                                                                                                                                                                                                                                       |           |
| Painful         | weapon_properties/Painful.js        | Done | impl-w2  | onResolve: when isActing + isSuccess, marks 1 Stress on attacker |                                                                                                                                                                                                                                       |           |
| Paired          | weapon_properties/Paired.js         | Done | impl-wpb3 | onIntent: +tier+1 damage static at melee range; reads tier from secondaryWeapon |                                                                                                                                                                                                                                       |           |
...
*Last updated: 2026-03-21 (impl-wpb3) — Implemented Long, Lucky, Massive, Otherworldly, Paired weapon properties. All 757 tests passing.*
...
| Eruptive        | weapon_properties/Eruptive.js       | Done | impl-wp3 | onResolve: successful melee attack splashes ceil(hpDamage/2) to adversaries within Very Close range; reaction roll 2d12 vs DC 14 per target |                                                                                                                                                                                    |                                                                                                                                                                                                                                       |           |
| Grappling       | weapon_properties/Grappling.js      | Done | impl-wp3 | Two reviewAction chips (hopeCost: 1 each): Restrain (addCondition) or Pull (move to melee) |                                                                                                                                                                                    |                                                                                                                                                                                                                                       |           |
| Greedy          | weapon_properties/Greedy.js         | Done | impl-wp3 | Intent toggle chip with temporaryStatMods proficiency +1; gold cost is narrative (no goldCost API) |                                                                                                                                                                                    |                                                                                                                                                                                                                                       |           |
...
| Hooked          | weapon_properties/Hooked.js         | Done | impl-wp3 | reviewAction chip (no cost): move target to melee range on successful attack |                                                                                                                                                                                    |                                                                                                                                                                                                                                       |           |
...
| Locked On       | weapon_properties/LockedOn.js       | Done | impl-wp3 | onResolve stores target on success; onIntent setOutcome('hope') + narration on next attack vs same target; primary-weapon restriction not enforceable (no weaponId on action) |                                                                                                                                                                                    |                                                                                                                                                                                                                                       |           |

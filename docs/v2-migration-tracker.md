...
| Eruptive        | weapon_properties/Eruptive.js       | Done | impl-wpb1 | onResolve: on successful melee attack, triggers reaction roll (14) action loops on nearby adversaries within Very Close range |                                                                                                                                                                                                                                       |           |
| Grappling       | weapon_properties/Grappling.js      | Done | impl-wpb1 | Two reviewAction chips (1 Hope each): Restrain (addCondition) or Pull (move to melee) on successful attack |                                                                                                                                                                                                                                       |           |
| Greedy          | weapon_properties/Greedy.js         | Done | impl-wpb1 | Intent toggle chip: spend gold for temporaryStatMods proficiency +1 on attacks |                                                                                                                                                                                                                                       |           |
...
| Hooked          | weapon_properties/Hooked.js         | Done | impl-wpb1 | reviewAction chip: pull target into Melee range (move) on successful attack, no cost |                                                                                                                                                                                                                                       |           |
...
| Locked On       | weapon_properties/LockedOn.js       | Done | impl-wpb1 | onResolve: stores lockedTargetId on success; onIntent: setOutcome('hope') on next attack against same target, then clears |                                                                                                                                                                                                                                       |           |

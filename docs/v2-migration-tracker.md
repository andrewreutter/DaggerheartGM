...
| Eruptive        | weapon_properties/Eruptive.js       | Done | impl-eghkl | onResolve: on successful melee attack, finds nearby adversaries in Very Close range, rolls d20 reaction (DC 14) for each; failed rolls take half HP damage (rounded up) |                                                                                                                                                                                                                                       |           |
| Grappling       | weapon_properties/Grappling.js      | Done | impl-eghkl | Two reviewAction chips (1 Hope each): Restrain (adds Restrained condition) or Pull (move target to Melee range) |                                                                                                                                                                                                                                       |           |
| Greedy          | weapon_properties/Greedy.js         | Done | impl-eghkl | Intent toggle chip: temporaryStatMods proficiency +1 on attacks (gold cost is narrative, not tracked by engine) |                                                                                                                                                                                                                                       |           |
...
| Hooked          | weapon_properties/Hooked.js         | Done | impl-eghkl | reviewAction chip: on successful attack, pull target to Melee range (no cost) |                                                                                                                                                                                                                                       |           |
...
| Locked On       | weapon_properties/LockedOn.js       | Done | impl-eghkl | onResolve: stores locked target ID on successful attack; onIntent: adds +100 static to guarantee auto-success on next attack against same target, then clears lock |                                                                                                                                                                                                                                       |           |

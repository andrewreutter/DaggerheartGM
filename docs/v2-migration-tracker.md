...
| Long            | weapon_properties/Long.js           | Done | impl-wp5 | Narrative only — targets all adversaries in a line (GM determines targeting) |                                                                                                                                                                                                                                       |           |
| Lucky           | weapon_properties/Lucky.js          | Done | impl-wp5 | reviewAction chip: on failed attack, mark 1 Stress to reroll both duality dice |                                                                                                                                                                                                                                       |           |
| Massive         | weapon_properties/Massive.js        | Done | impl-wp5 | passiveStatMods evasion -1; onReviewAction: on successful attack, rolls extra damage die, discards lowest |                                                                                                                                                                                                                                       |           |
| Otherworldly    | weapon_properties/Otherworldly.js   | Done | impl-wp5 | reviewAction toggle chip (chip-gates-hook): on successful attack, switch damage type to magic |                                                                                                                                                                                                                                       |           |
| Painful         | weapon_properties/Painful.js        | Done | impl-w2  | onResolve: when isActing + isSuccess, marks 1 Stress on attacker |                                                                                                                                                                                                                                       |           |
| Paired          | weapon_properties/Paired.js         | Done | impl-wp5 | onIntent: adds tier+1 damage static on melee attacks (reads secondaryWeapon.tier) |                                                                                                                                                                                                                                       |           |

...
| Long            | weapon_properties/Long.js           | Done | impl-wp5 | Narrative only — targets all adversaries in a line (GM-adjudicated targeting) |                                                                                                                                                                                                                                       |           |
| Lucky           | weapon_properties/Lucky.js          | Done | impl-wp5 | reviewAction chip (stressCost: 1) rerolls both Hope+Fear dice on failed attack |                                                                                                                                                                                                                                       |           |
| Massive         | weapon_properties/Massive.js        | Done | impl-wp5 | passiveStatMods evasion -1; onReviewAction: rolls extra die matching weapon, drops lowest across all dice |                                                                                                                                                                                                                                       |           |
| Otherworldly    | weapon_properties/Otherworldly.js   | Done | impl-wp5 | reviewAction toggle chip (chip-gates-hook) switches damageType to 'magic' on successful attack |                                                                                                                                                                                                                                       |           |
| Painful         | weapon_properties/Painful.js        | Done | impl-w2  | onResolve: when isActing + isSuccess, marks 1 Stress on attacker |                                                                                                                                                                                                                                       |           |
| Paired          | weapon_properties/Paired.js         | Done | impl-wp5 | onIntent: +2 static to damage roll on melee attacks |                                                                                                                                                                                                                                       |           |

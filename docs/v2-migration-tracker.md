...
| Eruptive        | weapon_properties/Eruptive.js       | Done | impl-wp3 | onReviewAction: on successful melee attack, finds other adversaries within Very Close of target, rolls d20 reaction (DC 14) for each, pushes half-damage effects for failures |                                                                                                                                                                                                                                       |           |
| Grappling       | weapon_properties/Grappling.js      | Done | impl-wp3 | Two reviewAction chips (Restrain or Pull), both hopeCost: 1, on successful attack; Restrain adds condition, Pull queues move to Melee |                                                                                                                                                                                                                                       |           |
| Greedy          | weapon_properties/Greedy.js         | Done | impl-wp3 | Intent toggle chip on attacks; temporaryStatMods proficiency +1; gold cost is narrative (no mechanical gold tracking) |                                                                                                                                                                                                                                       |           |
...
| Hooked          | weapon_properties/Hooked.js         | Done | impl-wp3 | reviewAction chip on successful attack (no cost); queues move target to Melee range |                                                                                                                                                                                                                                       |           |
...
| Locked On       | weapon_properties/LockedOn.js       | Done | impl-wp3 | onResolve stores locked target on success; onIntent adds +100 static bonus (auto-succeed) and clears lock when attacking same target |                                                                                                                                                                                                                                       |           |

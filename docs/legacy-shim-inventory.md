...
| Banner UI | `onBanner` noop vs `placement: 'banner'` chips | `GMTableView.jsx`, `ISeeItComing.js` | — | Medium |
...
| Weapon tags | `f.onBanner` for narration | `GMTableView.jsx` getBannerNarration | — | Low (keep) |

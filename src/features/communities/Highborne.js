/**
 * Highborne community builder.
 *
 * Features:
 *   Privilege — Advantage on rolls to consort with nobles, negotiate prices, leverage reputation.
 */
export default {
  name: 'Highborne',
  ...
  onCharacterBuild(char) {
    char.addFeature(
      ...
      {
        onCharacterRender: (ctx) => ctx.addAdvantageTrigger('consort with nobles, negotiate prices, or leverage your reputation to get what you want'),
      }
    );
  },
};

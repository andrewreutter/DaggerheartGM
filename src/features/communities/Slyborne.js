/**
 * Slyborne community builder.
 *
 * Features:
 *   Scoundrel — Advantage on negotiate with criminals, detect lies, find safe place to hide.
 */
export default {
  name: 'Slyborne',
  ...
  onCharacterBuild(char) {
    char.addFeature(
      ...
      {
        onCharacterRender: (ctx) => ctx.addAdvantageTrigger('negotiate with criminals, detect lies, or find a safe place to hide'),
      }
    );
  },
};

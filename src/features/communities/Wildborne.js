/**
 * Wildborne community builder.
 *
 * Features:
 *   Lightfoot — Advantage on rolls to move without being heard.
 */
export default {
  name: 'Wildborne',
  ...
  onCharacterBuild(char) {
    char.addFeature(
      ...
      {
        onCharacterRender: (ctx) => ctx.addAdvantageTrigger('move without being heard'),
      }
    );
  },
};

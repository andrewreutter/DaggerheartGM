/**
 * Ridgeborne community builder.
 *
 * Features:
 *   Steady — Advantage on traverse cliffs, harsh environments, survival.
 */
export default {
  name: 'Ridgeborne',
  ...
  onCharacterBuild(char) {
    char.addFeature(
      ...
      {
        onCharacterRender: (ctx) => ctx.addAdvantageTrigger('traverse dangerous cliffs and ledges, navigate harsh environments, and use your survival knowledge'),
      }
    );
  },
};

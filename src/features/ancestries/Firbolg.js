...
export default {
  ...
  onCharacterBuild(char) {
    char.addFeature(
      'Charge',
      'When you move and then make an Agility roll, you gain a benefit on success (add advantage d6).',
      {
        onAct(ctx) {
          ctx.canvas.addChip({
    ...
    char.addFeature(
      'Unshakable',
      'Before you mark Stress, you can roll a d6. On a 6, you do not mark the Stress.',
      {

/**
 * Clank ancestry builder.
 *
 * Features:
 *   Purposeful Design — At character creation, choose one Experience for a permanent +1 (onCharacterEdit + addExperienceBonus + form dropdown).
 *   Efficient         — On short rest, can choose long rest moves (onRest adds long moves to short list).
 */
export default {
  name: 'Clank',

...
export default {
  ...
  features: [
    {
      name: 'Danger Sense',
      description: 'When an adversary attack would target you or an ally within Very Close range, you can **mark a Stress** (once per rest) to reroll the entire attack roll.',
      onBanner(banner) {
        banner.addChip({

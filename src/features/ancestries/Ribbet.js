...
export default {
  ...
  onCharacterBuild(char) {
    char.addFeature(
      'Long Tongue',
      'You can attack a target within Close range using your tongue as a **Finesse** weapon that deals **d12** physical damage using your Proficiency. **Mark a Stress** when you use this attack.',
      {
    ...
    char.addFeature(
      'Amphibious',
      'You can breathe air and water and move through water without penalty.',
      // Narrative only — display is the correct final state
    );
  },
};

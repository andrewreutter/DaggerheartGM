...
export default {
  ...
  features: [
    {
      name: 'Shell',
      description: 'Your shell provides natural protection. Add your Proficiency to both your Major and Severe damage thresholds.',
      onCharacterRender: (ctx) => ctx.addThresholdBonus(ctx.proficiency ?? 1),
    },
    {
      name: 'Retract',
      description: 'You can retract into your shell, gaining resistance to physical damage but suffering disadvantage on action rolls and being unable to move.',
      onCard(card) {

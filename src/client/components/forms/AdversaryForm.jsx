    ...
    <>
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-5 gap-4 mt-6">
          <FormRow label="Difficulty">
            <div className="flex items-center gap-2">
              <input type="number" value={formData.difficulty} onChange={e => update({ ...formData, difficulty: parseInt(e.target.value) })} className="flex-1 min-w-0 bg-dh-inset border border-dh-border rounded p-2 text-dh" />
          ...
          <FormRow label="Stress">
            <div className="flex items-center gap-2">
              <input type="number" value={formData.stress_max} onChange={e => update({ ...formData, stress_max: parseInt(e.target.value) })} className="flex-1 min-w-0 bg-dh-inset border border-dh-border rounded p-2 text-dh" />
          ...
          <FormRow label="HP">
            <div className="flex items-center gap-2">
              <input type="number" value={formData.hp_max} onChange={e => update({ ...formData, hp_max: parseInt(e.target.value) })} className="flex-1 min-w-0 bg-dh-inset border border-dh-border rounded p-2 text-dh" />
          ...
          <FormRow label="Major Threshold">
            <div className="flex items-center gap-2">
              <input type="number" value={formData.hp_thresholds.major} onChange={e => update({ ...formData, hp_thresholds: { ...formData.hp_thresholds, major: parseInt(e.target.value) } })} className="flex-1 min-w-0 bg-dh-inset border border-dh-border rounded p-2 text-dh" />
          ...
          <FormRow label="Severe Threshold">
            <div className="flex items-center gap-2">
              <input type="number" value={formData.hp_thresholds.severe} onChange={e => update({ ...formData, hp_thresholds: { ...formData.hp_thresholds, severe: parseInt(e.target.value) } })} className="flex-1 min-w-0 bg-dh-inset border border-dh-border rounded p-2 text-dh" />
        ...
        <div className="mt-6 border-t border-dh-border pt-4">
          <h4 className="font-medium text-dh mb-4">Attack</h4>
          <div className="bg-dh-inset p-3 rounded border border-dh-border flex flex-col gap-3">
            <div className="grid grid-cols-12 gap-2">
              <div className="col-span-5"><input type="text" placeholder="Attack Name" value={formData.attack.name} onChange={e => update({ ...formData, attack: { ...formData.attack, name: e.target.value } })} className="w-full bg-dh-surface border border-dh-border rounded px-2 py-1 text-sm text-dh" /></div>
              <div className="col-span-4">
                <select value={formData.attack.range} onChange={e => update({ ...formData, attack: { ...formData.attack, range: e.target.value } })} className="w-full bg-dh-surface border border-dh-border rounded px-2 py-1 text-sm text-dh">
                  {RANGES.map(r => <option key={r} value={r}>{r}</option>)}
                </select>
              </div>
              <div className="col-span-3">
                <select value={formData.attack.trait} onChange={e => update({ ...formData, attack: { ...formData.attack, trait: e.target.value } })} className="w-full bg-dh-surface border border-dh-border rounded px-2 py-1 text-sm text-dh">
            ...
            <div className="grid grid-cols-12 gap-2">
              <div className="col-span-4 flex items-center gap-2">
                <span className="text-sm text-dh-muted">Mod:</span>
                <input type="number" placeholder="+0" value={formData.attack.modifier} onChange={e => update({ ...formData, attack: { ...formData.attack, modifier: parseInt(e.target.value) || 0 } })} className="flex-1 min-w-0 bg-dh-surface border border-dh-border rounded px-2 py-1 text-sm text-dh" />
              ...
              <div className="col-span-8 flex items-center gap-2">
                <span className="text-sm text-dh-muted">Dmg:</span>
                <input type="text" placeholder="e.g. d8+2" value={formData.attack.damage} onChange={e => update({ ...formData, attack: { ...formData.attack, damage: e.target.value } })} className="flex-1 min-w-0 bg-dh-surface border border-dh-border rounded px-2 py-1 text-sm text-dh" />
                {(() => {

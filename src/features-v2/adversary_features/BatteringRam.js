/**
 * Adversary action — Battering Ram (SRD)
 *
...
export const BatteringRam = {
  ...
  adversaryAuraReminder: "Close — they could feasibly smash (such as a wall, cart, or market stand) and destroy it.",
};
